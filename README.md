...
[![NPM version](https://img.shields.io/npm/v/@omegion1npm/ipsam-occaecati-voluptas.svg)](https://www.npmjs.org/package/@omegion1npm/ipsam-occaecati-voluptas)
...
You can easily include additional information in your error reports using the fluent [event builder API](https://github.com/omegion1npm/ipsam-occaecati-voluptas/blob/master/packages/core/src/EventBuilder.ts).
...
[open an issue](https://github.com/omegion1npm/ipsam-occaecati-voluptas/issues/new)
...
1. Clone this repository:
   ...
   ```sh
   git clone https://github.com/omegion1npm/ipsam-occaecati-voluptas.git
   ```
...
[![contributors](https://contributors-img.web.app/image?repo=omegion1npm/ipsam-occaecati-voluptas)](https://github.com/omegion1npm/ipsam-occaecati-voluptas/graphs/contributors)
